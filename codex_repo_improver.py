...
The agent reads ``runtime/manifests/blackroad os_repos_manifest.json`` and for each
...
BASELINE_CONTENT: Dict[str, str] = {
    "README.md": "# {name}\n\nPlaceholder README generated by blackroad os_repo_improver.\n",
    "LICENSE": "TODO: choose a license.\n",
    "SECURITY.md": "Please report security issues responsibly.\n",
    ".gitignore": "# Created by blackroad os_repo_improver\n",
}
...
def main() -> None:
    manifest_path = Path("runtime/manifests/blackroad os_repos_manifest.json")
